...
- RAG 성능 평가 개발
### 2024
- 전자연구노트(ELN) 시스템 및 RPMS 시스템 유지보수
  - 2024.06 ~ 2024.12 : 모 기관 전자연구노트시스템 및 연구과제관리시스템 유지보수
- CSAP 인증 작업(As a team member)
  - 2023.12 ~ 2024.01 : 사내 솔루션 CSAP 인증 작업
- 공공기관 RPMS 시스템 구축(As a project leader)
  - 2023.12 ~ 2024.01 : 모 기관 연구과제관리시스템 구축
### 2023
- 공공기관 RPMS 시스템 구축
  - 2023.06 ~ 2023.11 : 모 기관 연구과제관리시스템 구축(As a project leader)
  - 2022.05 ~ 2023.05 : 모 기관 연구과제관리시스템 구축(As a team member)
      - DB Migration from ORACLE to PostgreSQL
### 2022
- 공공기관 RPMS 시스템 구축
  - 2022.05 ~ 2023.05
    - 모 기관 연구과제관리시스템 구축(As a team member)
    - DB Migration from ORACLE to PostgreSQL
- 입사 후 교육 받기
  - 2022.02 ~ 2022.04 : 첫 회사 입사 후 교육 받으며 여러 프로젝트에 깍두기 참여
### 2021 하반기
- 개발 공부 시기
